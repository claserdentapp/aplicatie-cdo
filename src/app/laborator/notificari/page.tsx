    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-4">
          <Link href="/laborator" className="text-muted-foreground hover:text-foreground transition-colors bg-muted/30 p-2 rounded-full hover:bg-muted/60">
            <ArrowLeft className="h-5 w-5" />
          </Link>
          <div>
            <h1 className="text-2xl font-semibold">Notificări</h1>
            <p className="text-sm text-muted-foreground mt-0.5">Statusuri și actualizări.</p>
          </div>
        </div>
