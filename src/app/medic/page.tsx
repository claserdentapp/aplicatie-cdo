  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold md:text-3xl">{t("medicTitle")}</h1>
          <p className="text-sm text-muted-foreground mt-1">{t("medicDesc")}</p>
        </div>
        <div className="flex flex-wrap items-center gap-3 sm:gap-4">
          <Link className="text-sm font-medium hover:underline underline-offset-4 flex items-center gap-1.5" href="/medic/notificari">
